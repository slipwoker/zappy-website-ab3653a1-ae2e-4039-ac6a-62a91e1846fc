    ...
    contactForm.addEventListener('submit', async function(e) {
      ...
      if (!window.zappyContactFormLoaded) {
        try {
          ...
          const zappyPayload = {
            websiteId: 'ab3653a1-ae2e-4039-ac6a-62a91e1846fc',
            name: formData.fullName,
            email: formData.email,
            subject: 'Contact Form Submission - Beit Knesset Achdut',
            message: `
...
אישור תנאים: ${formData.terms ? 'כן' : 'לא'}
            `.trim(),
          ...
          if (response.ok) {
            ...
            console.error('❌ Zappy: API returned error', result);
          }
        } catch (error) {
      ...
      alert('תודה על ההרשמה! נחזור אליכם בהקדם.');
      contactForm.reset();
    });
  }
});
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בית הכנסת אחדות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
